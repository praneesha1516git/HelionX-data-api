...
var createSolarUnit = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, serialNumber, installationDate, capacity, status, newSolarUnit, createSolarUnit_1, error_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                createSolarUnit_1 = _b.sent();
                res.status(201).json(createSolarUnit_1);
                return [3 /*break*/, 3];
            case 2:
                error_2 = _b.sent();
                res.status(500).json({ message: "internal server error" });
...
var updateSolarUnit = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, _a, serialNumber, installationDate, capacity, status, solarUnit, updateSolarUnit;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                id = req.params.id;
